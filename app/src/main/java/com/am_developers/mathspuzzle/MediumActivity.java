    ...
    public void checkforScore() {
        if (i == 1) {
            ...
            if (ans4.getText().equals("9"))
                score += 3.5;
            if (ans5.getText().equals("4"))
                score += 3.5;
            if (ans6.getText().equals("17"))
                score += 2.5;
        } else if (i == 2) {
            if (ans1.getText().equals("14"))
                score += 3.5;
            if (ans2.getText().equals("2"))
                score += 3.5;
            if (ans3.getText().equals("15"))
                score += 3.5;
            if (ans4.getText().equals("5"))
                score += 3.5;
            if (ans5.getText().equals("0"))
                score += 3.5;
            if (ans6.getText().equals("9"))
                score += 2.5;
        } else if (i == 3) {
            if (ans1.getText().equals("27"))
                score += 3.5;
            if (ans2.getText().equals("14"))
                score += 3.5;
            ...
            if (ans5.getText().equals("0"))
                score += 3.5;
            if (ans6.getText().equals("20"))
                score += 2.5;
        } else if (i == 4) {
            if (ans1.getText().equals("21"))
                score += 3.5;
            if (ans2.getText().equals("20"))
                score += 3.5;
            if (ans3.getText().equals("1"))
                score += 3.5;
            if (ans4.getText().equals("0"))
                score += 3.5;
            if (ans5.getText().equals("5"))
                score += 3.5;
            if (ans6.getText().equals("8"))
                score += 2.5;
        } else if (i == 5) {
